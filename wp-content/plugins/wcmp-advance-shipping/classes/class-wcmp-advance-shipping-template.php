...
class WCMp_Advance_Shipping_Template {
    ...
    public function __construct() {
        ...
        add_action('wcmp_vendor_shipping_settings', array(&$this, 'output_wcmps_advance_shipping_table_rate'));
    ...
    public function output_wcmps_advance_shipping_table_rate() {
        $this->get_template('wcmp_advance_shipping_template_table_rate.php');
    }
